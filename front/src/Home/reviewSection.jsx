...
import { Marginer } from "../assets/components/marginer";
...
export function ReviewsSection(props) {
  ...
  return (
    <ReviewsContainer>
      <SectionTitle>Qué opinan nuestros expertos</SectionTitle>
      ...
      >
        <Slider>
          ...
          <StyledSlide index={1}>
            <ReviewCard
              reviewText=" Una buena oportunidad para aprender a programar. Gran iniciativa."
              username="Jesus"
              userImgUrl={User2Img}
            />
          </StyledSlide>
          ...
          <StyledSlide index={3}>
            <ReviewCard
              reviewText=" Magnífica oportunidad para aquellos estudiantes de programación. Incluso para trabajadores."
              username="Andrés"
              userImgUrl={User4Img}
            />
          </StyledSlide>
